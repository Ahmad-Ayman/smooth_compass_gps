...
import '../smooth_compass_gps.dart';
...
class SmoothCompassGPSWidget extends StatefulWidget {
...
class _SmoothCompassWidgetState extends State<SmoothCompassGPSWidget> {
  ...
  double _calculateQiblahOffset(double latitude, double longitude) {
    return QiblaUtilsGps.getOffsetFromNorth(latitude, longitude);
  }
